...
slug: "xr-makerthon"
period: "2024.11.22"
tech: ["Unity", "C#", "MRTK", "ARFoundation", "WebRTC", "Go", "SideQuest"]
...
siteUrl: ""
category: "hackathon"
teamMembers: "리서치 2명, 디자인 3명, 개발 2명"
myRole:
  title: "Unity Client Developer · AR/WebRTC"
  summary: "Metalense2 AR 글라스에서 화면 구성과 실시간 미디어 통신을 구현했습니다."
  contributions:
    - "Unity·ARFoundation 기반 AR 글라스 UI와 사용자 인터랙션 개발"
    - "WebRTC·WebSocketSharp를 활용한 클라이언트–서버 실시간 통신 구현"
    - "카메라 텍스처 포맷 호환 문제를 해결해 영상 스트림 정상화"
    - "3배 다운샘플링과 RenderTexture 변환으로 전송 성능 개선"
---

![기능](https://eaalkymxyfskjojh.public.blob.vercel-storage.com/portfolio/xr_makerthon/yoribogo-1.png)
![기능](https://eaalkymxyfskjojh.public.blob.vercel-storage.com/portfolio/xr_makerthon/yoribogo-2.png)
![기능](https://eaalkymxyfskjojh.public.blob.vercel-storage.com/portfolio/xr_makerthon/yoribogo-3.png)
![기능](https://eaalkymxyfskjojh.public.blob.vercel-storage.com/portfolio/xr_makerthon/yoribogo-4.png)
