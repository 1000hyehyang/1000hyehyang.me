...
tech: ["Spring Boot", "JPA", "QueryDSL", "WebSocket", "MySQL", "Redis", "RabbitMQ", "Docker", "GitHub Actions", "HAProxy", "RDS", "S3", "FCM", "React", "Vite", "TypeScript"]
...
myRole: "실시간 WebSocket 채팅 서비스 구현, S3 Presigned URL 기반 파일 스토리지 구현, FCM 웹 푸시 알림 및 Spring Mail 이메일 알림 시스템 구현"
---