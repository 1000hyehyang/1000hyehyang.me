...
tech: ["Spring Boot", "JPA", "MySQL", "Redis", "RabbitMQ", "WebSocket", "QueryDSL", "Docker", "GitHub Actions", "React", "Vite", "TypeScript"]
...
myRole: "실시간 WebSocket 채팅 서비스 구현, S3 Presigned URL 기반 파일 스토리지 구현"
---
