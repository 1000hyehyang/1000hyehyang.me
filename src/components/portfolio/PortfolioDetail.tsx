...
function ProjectTechList({
  ...
  if (!frontmatter.categorizedTech) {
    return (
      <div className="flex flex-wrap gap-2" data-content-reveal>
  ...
  return (
    <div className="space-y-5">
      {categories.map((category) => (
        <div key={category} className="space-y-2" data-content-reveal>
...
export function PortfolioDetail({
  ...
  return (
    <article ref={pageRef} className="w-full">
      <div className="portfolio-split-grid">
        <aside className="portfolio-detail-aside min-w-0 pb-2 pt-8 sm:pt-10 lg:sticky lg:top-[var(--site-header-height)] lg:self-start lg:py-10">
          ...
          <p data-scroll-reveal className="mb-3 text-xs font-medium uppercase tracking-[0.14em] text-brand">
            {displayCategory}
          </p>
          <h1 data-scroll-reveal className="portfolio-detail-title text-2xl font-semibold leading-tight tracking-[-0.04em] text-foreground lg:text-[1.75rem]">
            {frontmatter.title}
          </h1>

          {frontmatter.summary ? (
            <p data-scroll-reveal className="portfolio-detail-summary mt-6 text-sm leading-6 text-muted-foreground">
              {frontmatter.summary}
            </p>
          ) : null}
          ...
          {hasLinks ? (
            <div data-scroll-reveal className="portfolio-detail-links mt-7 flex flex-wrap gap-2">
        ...
        >
          ...
          {frontmatter.myRole ? (
            ...
            >
              ...
              <div data-scroll-reveal className="overflow-hidden rounded-2xl bg-muted/50">
